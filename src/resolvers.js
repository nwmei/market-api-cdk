...
import storeItemResolver from './resolverFunctions/storeItem';
import userExistsResolver from './resolverFunctions/userExists';
import myItemsResolver from './resolverFunctions/myItems';
...
export const resolvers = {
  Query: {
    ...
    sessionUserDetails: async (_, {input: {accessToken}}) => {
      ...
      console.log("session user Query called")
